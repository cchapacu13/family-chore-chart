...
const defaultChores = [
  { id: 1, name: "Making the bed", pay: 0.25, assignedTo: "both" },
  { id: 2, name: "Vacuum room", pay: 0.50, assignedTo: "both" },
  { id: 3, name: "Vacuum house", pay: 1.00, assignedTo: "both" },
  { id: 4, name: "Clean Room", pay: 1.00, assignedTo: "both" },
  { id: 5, name: "Laundry (Folding and taking clothes to closet)", pay: 3.00, assignedTo: "both" },
  { id: 6, name: "Feed Pets (Food & Water/Pet)", pay: 0.25, assignedTo: "both" },
  { id: 7, name: "Cleaning Dog Bowls", pay: 0.50, assignedTo: "both" },
  { id: 8, name: "Brush Dogs", pay: 1.00, assignedTo: "amelia" },
  { id: 9, name: "Clean car interior", pay: 0.50, assignedTo: "both" },
  { id: 10, name: "Read for 30 minutes", pay: 0.50, assignedTo: "both" },
  { id: 11, name: "Read for 1 hour", pay: 1.00, assignedTo: "both" },
  { id: 12, name: "Wipe bathroom counter", pay: 0.25, assignedTo: "both" },
  { id: 13, name: "Set table for dinner", pay: 0.50, assignedTo: "both" },
  { id: 14, name: "Clean table after dinner", pay: 0.50, assignedTo: "both" },
  { id: 15, name: "Take out trash", pay: 0.50, assignedTo: "both" },
  { id: 16, name: "Goal Score", pay: 3.00, assignedTo: "chrisjr" },
  { id: 17, name: "Assist", pay: 1.50, assignedTo: "chrisjr" },
  { id: 18, name: "Basketball basket", pay: 0.50, assignedTo: "chrisjr" },
  { id: 19, name: "Rebound", pay: 0.50, assignedTo: "chrisjr" },
  { id: 20, name: "Game Win", pay: 1.00, assignedTo: "chrisjr" },
  { id: 21, name: "Pick up dog poop", pay: 1.00, assignedTo: "amelia" },
  { id: 22, name: "Fill water container", pay: 0.25, assignedTo: "both" },
  { id: 23, name: "Pick up dog toys", pay: 0.25, assignedTo: "both" },
  { id: 24, name: "Wash dishes", pay: 1.00, assignedTo: "amelia" },
];
